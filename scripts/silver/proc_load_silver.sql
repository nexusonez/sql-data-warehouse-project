/*
===============================================================================
Store Procedure : Load Silver Layers (Bronze -> Silver)
===============================================================================
Script Purpose:
...
BEGIN
	...
	SELECT
	prd_id, 
	REPLACE(SUBSTRING(prd_key,1,5),'-','_') AS cat_id,	-- extracted category id -- this is to match the table's id in erp_px_cat_g1v2
	...
	-- Data Enrichment -- adding a new data to enhance the dataset for analysis
	CAST(LEAD(prd_start_dt) OVER (PARTITION BY prd_key ORDER BY prd_start_dt)-1 AS DATE) 
	AS prd_end_dt -- calculated end daate as one day before the next start day
